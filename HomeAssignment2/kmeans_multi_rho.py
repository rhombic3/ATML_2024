...
if __name__ == "__main__":
    k = 5
    t = 5
    rhos = [0.001, 0.01, 0.1, 1]
    rhos = np.linspace(0.001, 1, 50)  # 50 values between 0.001 and 1
    ...
    fig, ax = plt.subplots()
    ax.set_xlabel('rho')
    ax.set_ylabel('cost with varying rho')
    ax.plot(rhos, costs)
    plt.xscale('log')
    ...
    plt.savefig("result/cost_multi_rho.png")